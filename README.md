# Samsung Galaxy Codes | أكواد سامسونج

<p align="center">
  <img src="samsung-codes-preview-v3.svg" alt="Samsung Galaxy Codes Poster" width="100%">
</p>

<p align="center">
  <b>دليل مرتب لأكواد Samsung Galaxy مع تعريف مختصر ودرجة الأمان</b>
</p>

<p align="center">
  <img alt="Language" src="https://img.shields.io/badge/Language-Arabic%20%7C%20English-blue">
  <img alt="Device" src="https://img.shields.io/badge/Device-Samsung%20Galaxy-0ea5e9">
  <img alt="Safety" src="https://img.shields.io/badge/Safety-Safe%20%7C%20Sensitive%20%7C%20Danger-red">
</p>
...
ليست كل الأكواد تعمل على كل أجهزة Galaxy. قد تختلف حسب:

- موديل الجهاز
- إصدار Android / One UI
- المنطقة أو شركة الاتصالات
- صلاحيات النظام أو قفل بعض القوائم

للفحص الآمن الرسمي، استخدم تطبيق **Samsung Members** أو **Device Care**.

---

## فهرس المحتوى

- [درجة الأمان](#درجة-الأمان)
- [أكواد آمنة غالبًا](#-أكواد-آمنة-غالبًا)
- [الشبكة والاتصال](#-الشبكة-والاتصال)
- [Wi‑Fi / Bluetooth / GPS](#-wi-fi--bluetooth--gps)
- [الصوت والحساسات](#-الصوت-والحساسات)
- [USB / Logs / Debug](#-usb--logs--debug)
- [أكواد المكالمات والتحويل](#-أكواد-المكالمات-والتحويل)
- [أكواد قديمة أو قد لا تعمل](#-أكواد-نظام-قديمة-أو-قد-لا-تعمل)
- [أكواد خطيرة جدًا](#-أكواد-خطيرة-جدًا)
- [الأكواد التي تحتاجها فعليًا](#-الأكواد-التي-تحتاجها-فعليًا)

---

## درجة الأمان

| الرمز | التصنيف | المعنى |
|---|---|---|
| 🟢 | آمن | للعرض أو الفحص فقط غالبًا |
...
| الكود | التعريف | الأمان |
|---|---|---|
| `*#0011#` | Service Mode / معلومات الشبكة والواي فاي | 🟢 آمن للمشاهدة |
...
| `*2767*3855#` | Full Factory Reset وقد يمسح الجهاز بالكامل | 🔴 خطر جدًا |
...
| معلومات الشبكة والواي فاي | `*#0011#` | 🟢 آمن للمشاهدة |
...
إذا كان الدليل مفيدًا، يمكنك مشاركته أو حفظه للرجوع إليه عند فحص أجهزة Samsung Galaxy.
